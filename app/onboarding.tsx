...
const LEGAL_CONTENT = {
  ...
  privacy: {
    ...
    sections: [
      ...
      { heading: 'Sécurité, Hébergement et Prestataires', body: "Les données sont stockées de manière sécurisée via les serveurs chiffrés de Supabase (chiffrement SSL/TLS). L'application étant en phase de lancement associative, l'infrastructure évoluera vers un hébergement agréé HDS lors du déploiement à grande échelle. Les données sont partagées uniquement entre l'adhérent, son coach et les services de transport partenaires. Des sous-traitants certifiés conformes au RGPD peuvent intervenir pour des besoins techniques (cartographie GPS, routage SMS/notifications)." },
